                            ...
                            while ($r = mysqli_fetch_assoc($result)) {
                                echo '<tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="?m=mapel&s=delete&id=' . $r['id'] . '" class="btn btn-danger btn-sm" onclick="return confirm(\'Yakin kelas akan dihapus, Hapus 1 kelas akan menghapus semua data mapel\')">Hapus</a>
                                        </td>
                                    </tr>';
                                $no++;
                            }
